      ...
      <div className="min-h-[100dvh] grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col items-center justify-center px-6 py-12 bg-background">
          <div className="w-full max-w-sm text-center">
            <div className="w-12 h-12 rounded-full bg-chart-5/10 flex items-center justify-center mx-auto mb-5">
              <Check className="w-5 h-5 text-chart-5" />
            </div>
            <h1 className="text-2xl font-semibold text-foreground mb-2">
              Check your email
            </h1>
            <p className="text-sm text-muted mb-8 leading-relaxed max-w-[40ch] mx-auto">
            ...
            <Link
              href="/login"
              className="inline-flex items-center justify-center w-full bg-foreground text-background py-2.5 rounded-xl text-sm font-medium hover:opacity-90 transition-opacity"
            >
              Back to sign in
            </Link>
          </div>
            ...
            <div>
              ...
              {password.length > 0 && (
                <div className="mt-2.5 space-y-1">
                  <PasswordCheck met={passwordLength} label="At least 6 characters" />
