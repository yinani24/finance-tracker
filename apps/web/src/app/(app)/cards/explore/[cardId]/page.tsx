  ...
  return (
    <div className="flex shrink-0 flex-col items-end gap-1">
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground hover:bg-primary-hover disabled:opacity-50 motion-base active:translate-y-px"
      >
...
const backLink = (
  <Link
    href="/cards/explore"
    className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground motion-base"
  >
              ...
              >
                ...
                {offer.url && (
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground motion-base mt-2"
                  >
                    Offer terms
      ...
      {card.url && (
        <div className="mt-8">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-card px-4 py-2.5 text-sm font-medium text-card-foreground hover:bg-background motion-base"
          >
            Official card page
